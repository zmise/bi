...
module.exports = {
  ...
  listen: {
    ...
    mount: function () {
      ...
      // 设置导出地址
      this.$('#export').attr('to-url','/bi/marketing/houseSurveyRate/orgHouseSurveyRateStat.excel?').removeAttr('disabled');
    },
    renderTable: function () {
      ...
      this.list = this.$('#list').table({
        ...
        // }, {
          ...
          title: '实勘',
          name: 'houseSurveyCount',
          align: 'center',
          width: 140,
          lockWidth: true
        }, {
          title: '实勘率',
          name: 'houseSurveyRate',
          align: 'center',
          width: 120,
          lockWidth: true,
        ...
        height: 'auto' ,
        method: 'get',
        url: '/bi/marketing/houseSurveyRate/orgHouseSurveyRatePagingStat.json',
        indexCol: true,
        noDataText: '',
        fullWidthRows:true,
        indexColWidth: 60,
