...
module.exports = {
  ...
  listen: {
    ...
    renderEcharts: function() {
      this.refs.trend.trigger('fetchCompanyDealRateStat', {
        url: '/bi/marketing/org/trend/otherCompanyDealRateTop3.json',
        data: this.queryData()
      });
      this.refs.trend.trigger('fetchOtherDealRateStat', {
        url: '/bi/marketing/org/trend/gtTransferCount.json',
        data: this.queryData()
      });
    },
    query: function() {
  ...
  handle: {
    ...
    export: function() {
      location.href = '/bi/marketing/org/trend/exportCompanyDealRate.excel?' + $.param(this.queryData());
    }
  }
};
