...
module.exports = {
    ...
    listen: {
        ...
        initDefaultValue: function () {
            ...
            var lastyear = 2017; //最小年份 2017 
            var dif = year - lastyear;
            var yearValue = [];
            var data = {
                year: {
                    min: lastyear,
        ...
        fetchCityList: function (opt) {
            ...
            $.ajax({
                ...
                _this.city.render();
                _this.city.setValue(res.data[1]);
                _this.trigger('query');
        ...
        renderMyChart: function (data) {
            ...
            $('#myCharts .trapezoidal').each(function () {
                ...
                // }
                $this.closest('.trapezoidal').toggleClass('gray', +$this.find('span').text() === 0);
            });
        },
    ...
    mixins: [{
        formatValue: function (val) {
            ...
            // }
            // return +val;
            return isNaN(val) ? val : (parseInt(+val, 10) === +val ? +val : +(+val).toFixed(2));
        },
